...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .tp-spinner { width: 30px; height: 30px; border: 3px solid #2a2525; border-top-color: #ff5734; border-radius: 50%; animation: spin .7s linear infinite; }
      ...
      <div className="pg-main">
        ...
        {loading ? (
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 40 }}>
            <Hash size={60} color="#2a2525" style={{ marginBottom: 20 }} />
            <h3 style={{ color: '#8a7f7f', fontWeight: 900 }}>NO CLUSTERS TAGGED</h3>
          </div>
        ) : (
            ...
            <div className="tp-notes-panel">
              {!selectedTag ? (
                <div style={{ textAlign: 'center', padding: '100px 20px' }}>
                  <Inbox size={50} color="#2a2525" style={{ margin: '0 auto 20px' }} />
                  <h3 style={{ color: '#3a3535', fontWeight: 900 }}>SELECT A FRAGMENT</h3>
                  <p style={{ color: '#2a2525', fontSize: 12, fontWeight: 700, marginTop: 8 }}>CHOOSE A TAG TO VIEW DATA NODES</p>
                </div>
              ) : (
                <>
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32 }}>
                    <div style={{ padding: "6px 16px", background: "#000", borderRadius: "10px", color: "#ff5734", fontSize: 13, fontWeight: 900 }}>
