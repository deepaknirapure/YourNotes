...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.email || !form.password) return toast.error('Required fields are empty.');
    setLoading(true);
    try {
    ...
    <div className="login-root">
      ...
      <div className="login-left">
        ...
        <div className="left-content">
          <div className="neon-badge"><Zap size={12} fill="#ccff00" /> Secure Workspace</div>
          ...
          <div className="features-stack">
            <div className="feat-item">
              ...
              <div className="feat-text">
                ...
                <p>Advanced AI that structures your lecture notes into ready-to-study flashcards.</p>
              </div>
            </div>
            <div className="feat-item">
              <div className="feat-icon"><ShieldCheck size={20} /></div>
              <div className="feat-text">
                <h4>Vault-Grade Security</h4>
                <p>Your notes are private, encrypted, and accessible only by your authenticated key.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="login-right">
        <div className="form-container">
          <div className="form-header">
            ...
            <p className="form-subtitle">Welcome back. Authenticate to enter your hub.</p>
          </div>
