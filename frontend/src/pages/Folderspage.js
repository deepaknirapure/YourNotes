            ...
            <div className="fp-grid">
              {folders.map((folder, i) => (
                <div key={folder._id} className="fp-card" onClick={() => navigate(`/notes?folder=${folder._id}`)} style={{ animationDelay: `${i * 0.05}s` }}>
                  ...
                  {openMenu === folder._id && (
                    <div style={{ position: 'absolute', top: 50, right: 18, background: '#151313', borderRadius: 12, padding: 8, zIndex: 10, boxShadow: '0 10px 30px rgba(0,0,0,0.2)' }}>
                  ...
                  <div className="fp-icon-wrap" style={{ background: `${folder.color || "#ff5734"}15` }}>
                    <Folder size={26} color={folder.color || "#000"} fill={folder.color === "#ff5734" ? "#ff5734" : "none"} />
                  </div>
