...
const STYLES = `
  ...
  *, *::before, *::after { 
  ...
  .cm-stat-chip .sc-val  { font-size: 20px; font-weight: 800; color: var(--text); letter-spacing: -0.5px; }
  ...
  .cm-tab  { padding: 9px 16px; border: none; border-radius: 9px; font-size: 12px; font-weight: 800; cursor: pointer; transition: 0.25s; display: flex; align-items: center; gap: 7px; color: var(--text-muted); background: transparent; letter-spacing: 0.2px; }
  ...
  .cm-search { width: 100%; padding: 11px 10px; background: transparent; border: none; font-size: 13px; font-weight: 600; color: var(--text); outline: none; }
  ...
  .cm-subject-lbl  { font-size: 11px; color: var(--text-muted); font-weight: 800; text-transform: uppercase; letter-spacing: 1px; }
  .cm-subject-pill { padding: 7px 16px; border-radius: 20px; border: 1px solid var(--border); background: var(--surface); color: var(--text-muted); font-size: 12px; font-weight: 700; cursor: pointer; transition: 0.2s; }
  .cm-subject-pill:hover { border-color: #f97316; color: #f97316; }
  .cm-subject-pill.active { background: #f97316; border-color: #f97316; color: #fff; }

  .btn-share { display: flex; align-items: center; gap: 8px; background: #f97316; color: #fff; border: none; border-radius: 13px; padding: 10px 20px; font-size: 13px; font-weight: 800; cursor: pointer; transition: 0.25s; }
  .btn-share:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(249,115,22,0.3); }
  ...
  .cm-card:hover { border-color: #f97316; transform: translateY(-4px); box-shadow: 0 16px 40px rgba(0,0,0,0.1); }
  ...
  .cm-author-name { font-size: 14px; font-weight: 800; color: var(--text); }
  .cm-date { font-size: 11px; color: var(--text-muted); font-weight: 600; margin-top: 2px; }

  .cm-card-subject { display: inline-flex; align-items: center; gap: 5px; background: rgba(249,115,22,0.08); color: #f97316; border: 1px solid rgba(249,115,22,0.15); border-radius: 8px; padding: 4px 10px; font-size: 11px; font-weight: 800; margin-bottom: 12px; text-transform: uppercase; letter-spacing: 0.5px; }
  .cm-card-title   { font-size: 16px; font-weight: 800; color: var(--text); margin-bottom: 10px; line-height: 1.4; letter-spacing: -0.2px; }
  .cm-card-preview { font-size: 13px; color: var(--text-muted); font-weight: 500; line-height: 1.6; margin-bottom: 20px; flex: 1; opacity: 0.9; }
  ...
  .cm-act-btn { display: flex; align-items: center; gap: 6px; border: none; border-radius: 10px; padding: 8px 12px; font-size: 12px; font-weight: 800; cursor: pointer; transition: 0.2s; background: var(--bg); color: var(--text-muted); }
  .cm-act-btn:hover:not(:disabled) { background: var(--border); color: var(--text); }
  .cm-act-btn.liked, .cm-act-btn.saved { background: rgba(249,115,22,0.1); color: #f97316; }
  .cm-act-btn.dl { background: #f97316; color: #fff; }

  .cm-section-hd h3 { font-size: 12px; font-weight: 900; text-transform: uppercase; letter-spacing: 1.5px; color: var(--text); }
  
  /* Modals */
  .nd-sheet { border-radius: 24px; background: var(--surface); border: 1px solid var(--border); }
  .nd-popup-name { font-size: 15px; font-weight: 900; color: var(--text); }
  .nd-view-profile-btn { font-weight: 800; border-radius: 12px; background: #f97316; }
  
  .comment-input { font-weight: 500; border-radius: 14px; border: 1px solid var(--border); }
  .share-submit-btn { font-weight: 800; background: #f97316; border-radius: 14px; }
