...
const STYLES = `
  ...
  .home-greeting-name { font-size: clamp(20px,3vw,26px); font-weight: 800; color: var(--text); letter-spacing: -0.7px; margin-bottom: 4px; }
  ...
  .recent-item { display: flex; align-items: center; justify-content: space-between; padding: 13px 18px; border-bottom: 1px solid var(--border); transition: background 0.15s; cursor: pointer; }
    ...
    <div className="pg-wrap">
      ...
      <div className="pg-main">
        ...
        <div className="pg-topbar">
          ...
          <span style={{ fontSize: 15, fontWeight: 800, color: 'var(--text)', letterSpacing: '-0.3px' }}>Home</span>
        ...
        <div className="pg-content">
          ...
          <div className="home-greeting">
            ...
            <div className="home-greeting-sub">
              {stats.streak > 0 ? `You're on a ${stats.streak}-day streak. Keep going!` : 'Start writing to begin your streak today.'}
            </div>
          </div>

          {/* Quick Actions */}
          <div className="quick-actions">
            <button className="qa-btn primary" onClick={() => navigate('/dashboard')}><Plus size={15} /> New Note</button>
          ...
          <div className="section-header">
            ...
            <button className="btn-secondary" onClick={() => navigate('/dashboard')} style={{ padding: '6px 14px', fontSize: 13 }}>
          ...
          <div className="recent-card">
            {recent.length === 0 ? (
              <div className="empty-state" style={{ border: 'none', borderRadius: 0 }}>
                <div className="empty-state-icon"><FileText size={22} color="var(--text-3)" /></div>
                <h4>No notes yet</h4>
