...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pg-card:hover { 
    border-color: #3a3535; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.04); 
      ...
      <div className="pg-main">
        ...
        <div className="pg-topbar">
          ...
          <div className="pg-actions">
            ...
            <button onClick={loadStarred} style={{ background: "none", border: "none", color: "#8a7f7f", cursor: "pointer", display: "flex", padding: "8px", borderRadius: "8px", transition: "0.2s" }} onMouseOver={e=>e.currentTarget.style.background="#2a2525"} onMouseOut={e=>e.currentTarget.style.background="none"}>
              ...
              {filtered.map((note, i) => (
                <div key={note._id} className="pg-card" onClick={() => navigate("/dashboard")} style={{ animationDelay: `${i * 0.03}s` }}>
                  ...
                  <div className="pg-card-footer">
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#8a7f7f', fontSize: 12, fontWeight: 600 }}>
